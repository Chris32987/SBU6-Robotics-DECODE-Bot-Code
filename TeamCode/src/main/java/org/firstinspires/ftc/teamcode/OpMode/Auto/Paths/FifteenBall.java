...
public abstract class FifteenBall extends NextFTCOpMode {
    protected final Poses.AllianceColor alliance;
    private final double ShootTime = 0.8;

    public FifteenBall(Poses.AllianceColor alliance) {
        addComponents(
    ...
    // gate intake run 1
    private Pose ApproachGateIntake1Control = new Pose(0, 73.856);
    ...
    // gate intake run 2
    private Pose ApproachGateIntake2Control = new Pose(0, 73.856);
